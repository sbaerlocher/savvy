...
// Returns nil if the bundle is not initialized.
...
// Returns nil if the bundle is not initialized (e.g. in tests).
...
// Returns the messageID as fallback if the bundle is not initialized or translation is missing.
