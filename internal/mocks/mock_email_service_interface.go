...
func (m *MockEmailServiceInterface) SendShareNotification(ctx context.Context, toEmail, toName, fromName, resourceType, resourceURL, unsubscribeURL, language string) error {
	return m.Called(ctx, toEmail, toName, fromName, resourceType, resourceURL, unsubscribeURL, language).Error(0)
}

func (m *MockEmailServiceInterface) SendTransferNotification(ctx context.Context, toEmail, toName, fromName, resourceType, resourceURL, unsubscribeURL, language string) error {
	return m.Called(ctx, toEmail, toName, fromName, resourceType, resourceURL, unsubscribeURL, language).Error(0)
}
