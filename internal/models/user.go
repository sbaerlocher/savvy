...
type User struct {
	...
	PushNotificationsEnabled  bool       `gorm:"default:true" json:"push_notifications_enabled"`  // Global push notifications channel
	EmailNotificationsEnabled bool       `gorm:"default:true" json:"email_notifications_enabled"` // Global email notifications channel
	PushRemindersEnabled      bool       `gorm:"default:true" json:"push_reminders_enabled"`      // Push for expiry & validity start
	PushSharingEnabled        bool       `gorm:"default:true" json:"push_sharing_enabled"`        // Push for share & transfer
	EmailRemindersEnabled     bool       `gorm:"default:true" json:"email_reminders_enabled"`     // Email for expiry & validity start
	EmailSharingEnabled       bool       `gorm:"default:true" json:"email_sharing_enabled"`       // Email for share & transfer
