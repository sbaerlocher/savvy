...
type DashboardRepository interface {
	...
	LoadFavoriteCards(ctx context.Context, userID uuid.UUID, limit int) ([]models.Card, error)
	LoadRecentCards(ctx context.Context, userID uuid.UUID, limit int) ([]models.Card, error)
	LoadFavoriteVouchers(ctx context.Context, userID uuid.UUID, limit int) ([]models.Voucher, error)
	LoadRecentVouchers(ctx context.Context, userID uuid.UUID, limit int) ([]models.Voucher, error)
	LoadFavoriteGiftCards(ctx context.Context, userID uuid.UUID, limit int) ([]models.GiftCard, error)
