...
// Create creates a new merchant in the database.
...
// GetByID retrieves a merchant by its ID.
...
// GetByName retrieves a merchant by its name.
...
// Search searches for merchants by name (case-insensitive).
...
// Delete soft-deletes a merchant from the database.
