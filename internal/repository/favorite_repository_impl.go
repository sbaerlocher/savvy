...
// Create creates a new favorite record in the database.
...
// GetByUser retrieves all favorites for a specific user.
...
// Delete soft-deletes a favorite record.
...
// Restore restores a soft-deleted favorite record.
...
// IsFavorite checks if a resource is favorited by a user.
