	...
	>
		<div class="p-6">
			...
			{#if preferences.push_notifications_enabled}
				<div data-testid="push-subcategories" class="ml-4 mt-3 pl-4 border-l-2 border-gray-100 space-y-3">
					<ToggleSwitch
			...
			{#if preferences.email_notifications_enabled}
				<div data-testid="email-subcategories" class="ml-4 mt-3 pl-4 border-l-2 border-gray-100 space-y-3">
					<ToggleSwitch
