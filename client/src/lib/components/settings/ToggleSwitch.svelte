<script lang="ts">
	...
	const knobClass = IS_IOS
		? 'pointer-events-none absolute top-0.5 left-0.5 inline-block h-6.75 w-6.75 transform rounded-full bg-surface shadow-toggle transition-transform duration-280 ease-in-out'
