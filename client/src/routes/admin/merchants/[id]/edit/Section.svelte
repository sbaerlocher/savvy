		...
		<div class="lg:col-span-2">
			...
			>
				...
				>
					...
					<div>
						<label for="merchant-id" class="label">
					...
					<!-- Actions: same divided row as the other edit forms (paired
					     layout — compact primary + ghost cancel, delete hard right).
					     On Android the m3-filled-form CSS re-lays this last row out
					     as an M3 text button + filled pill, right-aligned. -->
					<div
						class={IS_ANDROID
							? 'flex gap-2 pt-4'
					...
					>
						...
						<button
							...
							disabled={isOffline}
							class="btn btn-text-danger {IS_ANDROID
								? ''
								: 'ml-auto'} flex items-center gap-1.5 {isOffline
